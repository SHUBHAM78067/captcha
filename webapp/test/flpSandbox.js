		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "captcha",
									"targetURL": "#captchacaptcha-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"captchacaptcha-display": {
								"semanticObject": "captchacaptcha",
								"action": "display",
								"description": "captcha",
								"title": "captcha",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=captcha.captcha",
									"url": sap.ui.require.toUrl("captcha/captcha")
								}
							}
						}
					}
